    ...
    <div class="card shadow  text-white bg-dark">
      ...
      <div class="card-body">
        <div class="btn-group w-100 mb-3" role="group" aria-label="Basic radio toggle button group">
          <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" onclick="getSuggestions()" checked >
          <label class="btn btn-outline-primary" for="btnradio1" id="get_suggestions_btn">Suggestions (<?php if(isset($suggest)): ?>
            <?php echo e($suggest); ?>

            <?php endif; ?> ) </label>

          <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off"  onclick="getsendRequests('sent')">
          ...
          <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off"  onclick="getRecieveRequests('Received')">
          ...
          <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off" onclick="getConnections()">
...
<?php /**PATH /var/www/html/curawork-coding-challenge/resources/views/components/network_connections.blade.php ENDPATH**/ ?>